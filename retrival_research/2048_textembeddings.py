...
model_name = "sentence-transformers/all-mpnet-base-v2"  # Use a BERT-based model
...
def get_bert_embedding(text, target_dim=2048):  # Target vector dimension set to 2048
...
# Generate embeddings and prepare JSON structure
...
for description in descriptions:
    ...
    # Generate embedding of 2048 dimensions
    vector = get_bert_embedding(truncated_description, target_dim=2048)

    # Prepare dictionary entry matching Milvus schema
    entry = {
        "vector": vector, 
        "descriptions": truncated_description  # Renamed field to match Milvus schema
    }
    description_vectors_list.append(entry)

# Save the embeddings and descriptions to a JSON file
output_file = "milvus_compatible_2048.json"
